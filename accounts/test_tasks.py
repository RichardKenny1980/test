...
class SyncWorkspaceDirectoryTests(TestCase):
    ...
    @patch("gcal.tasks.sync_calendar_for_user.delay")
    ...
    def test_creates_users_and_fans_out_sync(
        self, mock_is_enabled, mock_list_emails, mock_gmail_delay, mock_chat_delay, mock_cal_delay
    ):
        ...
        self.assertEqual(mock_cal_delay.call_count, 2)
